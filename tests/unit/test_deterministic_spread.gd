...
func _test_equal_seed_equal_sequence() -> void:
	var first: RefCounted = DeterministicSpreadScript.new()
	var second: RefCounted = DeterministicSpreadScript.new()
...
func _test_recoil_and_movement_expand_envelope() -> void:
	var spread: RefCounted = DeterministicSpreadScript.new()
	var definition: Resource = _make_definition()
